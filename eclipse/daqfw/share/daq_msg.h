...
#define DAQ_CMD_CHIP       0x00000020
#define DAQ_CMD_SYNC       0x00000040
#define DAQ_CMD_LED        0x00000080
#define DAQ_CMD_ADC_SEL    0x00000F00
#define DAQ_CMD_DEV_SEL    0x0000F000
#define DAQ_CMD_SCAN       0x00010000

// Channels per ADC
#define DAQ_MAX_CH         4

// Maximum samples per pipe message
#define DAQ_MAX_LEN        256

// Maximum channel samples per pipe message
#define DAQ_MAX_SAM        (DAQ_MAX_LEN / DAQ_MAX_CH)

// Pipe message pooling
#define DAQ_MAX_PIPE_RUN   32

// 3.3V / 2^15 (16-Bit Signed ADC), Internal Reference
#define DAQ_LSB            (3.3 / 16384.0)
...
typedef struct _cm_pipe_daq_t {
   ...
   uint32_t    fw_rev;         // Firmware Revisions
   uint32_t    hw_rev;         // Hardware Revisions
   uint32_t    magic;          // Magic Number
   uint16_t    samples[256];   // DAQ Samples
