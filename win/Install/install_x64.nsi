...
!define PRODUCT_PUBLISHER "Omniware Inc."
...
Section -Post
  ...
  WriteRegStr HKCU "${PRODUCT_INST_CLASS}\${PRODUCT_NAME}${PRODUCT_EXT}\DefaultIcon" "" "$INSTDIR\${PRODUCT_NAME}Doc.ico"
